...
function InfoCard({img, location, title, description, star, total, price}) {
    return (
        <div className="flex py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg pr-4 transition duration-200 ease-out first:border-t hover:scale-95">
            <div className="relative h-24 w-40 md:h-52 md:w-80 flex-shrink-0 mt-9 md:mt-0">
